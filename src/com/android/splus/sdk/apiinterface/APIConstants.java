...
public class APIConstants {
    ...
    public final static int SPLUS = 1;
    ...
    public static final String LOGIN_URL = "http://api.splusgame.com/sdk/login.php";

    public static final String ACTIVE_URL = "http://api.splusgame.com/sdk/active.php";
